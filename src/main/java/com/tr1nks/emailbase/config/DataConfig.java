 ...
 * пакеты для поиска сущностей
 * пакеты для поиска репозиториев
 * использование параметров из application.yml
 */
@Configuration
@EnableTransactionManagement
@PropertySource("classpath:application.yml")
@EnableJpaRepositories({"com.tr1nks.emailbase.model.repositories"})
public class DataConfig {
    private static final String entityPackage = "com.tr1nks.emailbase.model.entities";
    //db prop
